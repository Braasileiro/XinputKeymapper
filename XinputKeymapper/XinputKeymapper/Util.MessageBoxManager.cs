...
namespace System.Windows.Forms
{
	class MessageBoxManager
	{
		...
		public static string OK = "&OK"; // OK text
		public static string Cancel = "&Cancel"; // Cancel text
		public static string Abort = "&Abort"; // Abort text
		public static string Retry = "&Retry"; // Retry text
		public static string Ignore = "&Ignore"; // Ignore text
